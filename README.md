...
- использование констант в **NoCode** для получения их значений через функции  вычисляемых выражений модуля **Прикладные константы**. Например, константу можно указать в параметре процесса и использовать её в настройке варианта процесса;
  <img width="1193" height="344" alt="Функции вычисляемых выражений" src="https://github.com/user-attachments/assets/b5a2d7ce-efce-41f6-8c84-2ac354737460" />
